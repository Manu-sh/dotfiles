...
hi Normal	ctermfg=48	ctermbg=NONE	cterm=NONE	guifg=#d787ff		guibg=#0D151D
hi Type		ctermfg=42	ctermbg=NONE	cterm=NONE	guifg=#ff005f		"guibg=NONE
hi LineNr	ctermfg=122	ctermbg=NONE	cterm=NONE	guifg=#87ffd7		"guibg=NONE
hi Include	ctermfg=42	ctermbg=NONE	cterm=bold	guifg=#ff005f		"guibg=NONE
...
hi Macro	ctermfg=49	ctermbg=NONE	cterm=NONE	guifg=#875fff		"guibg=NONE
hi Boolean	ctermfg=49	ctermbg=NONE	cterm=NONE	guifg=#875fff		"guibg=NONE
hi Constant	ctermfg=49	ctermbg=NONE	cterm=NONE	guifg=#8700d7		"guibg=NONE
...
hi Repeat	ctermfg=49	ctermbg=NONE	cterm=NONE	guifg=#875fff		"guibg=NONE
hi Conditional  ctermfg=49	ctermbg=NONE	cterm=NONE	guifg=#875fff		"guibg=NONE
